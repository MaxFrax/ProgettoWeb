CREATE TABLE app.USER_DETAIL(
	...
	ID_CONFIRMATION CHAR(64),
	USER_TYPE SMALLINT NOT NULL, --('REGISTERED', 'SELLER', 'ADMINISTRATOR', 'REGISTRATION_PENDING')
	PRIMARY KEY(ID),
	UNIQUE(EMAIL),
	UNIQUE(USERNAME)
);
...
CREATE TABLE app.ISSUE(
	...
	SELLER_READ BOOLEAN,
	ADMIN_READ BOOLEAN,
	ADMIN_CHOICE SMALLINT, --('PENDING', 'REFUND', 'DO_NOTHING', 'BAD_REVIEW', 'NOT_VALID')
